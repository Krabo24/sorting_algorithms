...
/**
 * hoare_partition - Order subset of array of integers according
 ...
 * Description: Uses last element of partition as the pivot
...
/**
 * hoare_sort - Implement quick sort algorithm through recursion
 ...
 * @array: Array of integers
 * @size: Size of array
 * Description: Uses Hoare partition scheme and Prints the 
 * array after each swap of the two elements
 */
